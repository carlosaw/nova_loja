        ...
        <div class="filtercontent">
          ...
          <?php foreach($viewData['filters']['brands'] as $bitem): ?>
            <div class="filteritem">
              ...
              <label class="lbrand" for="filter_brand<?php echo $bitem['id']; ?>"><?php echo $bitem['name']; ?></label>
        ...
        <div class="filtercontent">
          ...
          <div class="filteritem">
            ...
            <label for="filter_star1">
              <img src="<?php echo BASE_URL; ?>assets/images/star.png" style="width:15px;margin-top:-6px;"/>
            </label>
